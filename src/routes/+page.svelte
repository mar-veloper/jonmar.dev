...
<div class="flex flex-col items-start relative mb-10">
	<div
		class="text-right w-2/4 xl:w-[600px] opacity-75 absolute top-[15%] right-0 hover:mask-half-1"
	>
		<img src={avatar} alt="jonmar" />
		<h2 class="text-[2vw] xl:text-[24px] font-bold">Jonmar Montaniel</h2>
		<h3 class="text-[1.6vw] xl:text-[20px] font-md">Software Developer</h3>
	</div>

	<p class="text-[8.5vw] xl:text-[110px] font-bold w-3/4 opacity-80 pb-8">
	...
	<p class="text-[4.25vw] xl:text-[62px] font-bold w-3/4 opacity-80 z-10 pb-8">
		At the moment, I'm actively expanding my knowledge in Java, while also refining my skills in
		data structures, algorithms, and design patterns.
	</p>
	<p class="text-[2vw] xl:text-[30px] font-bold w-3/4 opacity-80 z-10">
